let celulares = [];
celulares.push(new Producto(1,"Samsung","Galaxy A52","https://storage.comprasmartphone.com/smartphones/samsung-galaxy-a52.png",120000,3)),
...
localStorage.setItem("celSamsung",JSON.stringify(samsung))
localStorage.setItem("celMotorola",JSON.stringify(motorola))
localStorage.setItem("celiPhone",JSON.stringify(iPhone))
localStorage.setItem("celXiaomi",JSON.stringify(xiaomi))
localStorage.setItem("celHuawei",JSON.stringify(huawei))
